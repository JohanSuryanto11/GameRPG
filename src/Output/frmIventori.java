 ...
 * @author johan
 */
public class frmIventori extends javax.swing.JFrame {
    protected Iventori tbliventori = new Iventori();
    /**
    ...
    private void initComponents() {
        ...
        cmbcari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "IdIventori", "IdHero", "Nama", "Tipe" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addComponent(jspsiswa, javax.swing.GroupLayout.PREFERRED_SIZE, 428, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addComponent(jspsiswa, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btncariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncariActionPerformed
        ...
        if(!txtcari.getText().trim().equalsIgnoreCase("")){
            ...
            tableHeader.add("Id");
            tableHeader.add("IdHero");
            tableHeader.add("nama");
            tableHeader.add("tipe");
            tableHeader.add("Atk");
            tableHeader.add("Def");
            tableHeader.add("Spd");
            tableHeader.add("HP");

            Vector tableData = tbliventori.LookUp(cmbcari.getSelectedItem().toString(), txtcari.getText());
    ...
    jspsiswa.getVerticalScrollBar().setValue(jtbsiswa.getRowCount()*jtbsiswa.getRowHeight());
     ...
     Vector<String> tableHeader = new Vector<String>();
        tableHeader.add("Id");
            ...
            tableHeader.add("Spd");
            tableHeader.add("HP");
        Vector tableData = tbliventori.Load();
        if(tableData!=null){
            jtbsiswa.setModel(new DefaultTableModel(tableData,tableHeader));
            DefaultTableCellRenderer renderer=new DefaultTableCellRenderer();
            renderer.setHorizontalAlignment(JLabel.RIGHT);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmIventori.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmIventori().setVisible(true);
            }
        });
    }
